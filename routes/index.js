...
router.get('/chart-test', indexController.getChartHTML)
router.get('/custom-statistics', indexController.getCustomStatsHTML)
router.get('/css/custom-statistics.css', indexController.getCSS)
router.get('/assets/img/graph.png', indexController.getSVG)
